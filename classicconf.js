...
//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'ꪶ༺֎ᚏ༈MILTON⧉ᚙ֎⸙༻' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
global.owner = ['263715907468'] // ubah aja pake nomor lu
//==========================zetsuboclient=======================//
...
global.prefa = ['','!','.',',','🐤','🗿']
global.sessionName = 'VAJIRA-MD=HN0z3JSL#gv7LhAaW_nJJklRjF_oazWMYcCWyqIQatT4ca5ux_9k'  //Gausah Juga
