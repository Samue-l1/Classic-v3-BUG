...
zetsubo.sendMessage(m.chat, { image: { url: anu }, caption: `Made by ${global.botname}` ,  quoted: m, contextInfo: { externalAdReply:{
 }}}, {quoted: m})
//=================================================//
case 'sound1':
case 'sound2':
...
case 'play':
    case 'stream': {
        ...
        try {
	reply('𝑾𝒂𝒊𝒕 𝒂 𝒎𝒐𝒎𝒆𝒏𝒕 𝒂𝒔 𝒘𝒆 𝒂𝒏𝒂𝒍𝒚𝒔𝒆')
            const {
                videos
            } = await yts(text);
			...
			caption: 𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃 𝐁𝐘 𝐂𝐋𝐀𝐒𝐒𝐈𝐂-𝐕3 ®2024
                    }, {
                        quoted: m
                    }
                );
