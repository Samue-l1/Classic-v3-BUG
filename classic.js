...
const reply = (teks) => {
return zetsubo.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `༐༑⿻𝐒⸙𝐀࿈𝐌.𝐕𖤓𝐕𝐢𝐒𝐢𝐎𝐍⿻༔༐༑ - ${botname}`,"body": `Selamat ${salam2} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/565f8fc3e0cffb4a7ffd4.jpg',"thumbnail": thumbnail,"sourceUrl": `https://www.instagram.com/ano_nymous_sam?utm_source=qr&igsh=MzNlNGNkZWQ4Mg%3D%3D`}}}, { quoted:m})} 
...
const zetsreply = async (teks) => {
        ...
        mediaUrl: `https://www.instagram.com/ano_nymous_sam?utm_source=qr&igsh=MzNlNGNkZWQ4Mg%3D%3D`,
        mediaType: 2, 
        thumbnail:sangean
        }}}, { quoted: zets })}
...
│    📚𝐋𝐢𝐛𝐫𝐚𝐫𝐲 : *𝐁𝐚𝐢𝐥𝐞𝐲𝐬-𝐌𝐃*.
║	👾𝐏𝐫𝐞𝐟𝐢𝐱 : *𝐌𝐮𝐥𝐭𝐢-𝐏𝐫𝐞𝐟𝐢𝐱*.
│	📅𝐃𝐚𝐭𝐞 𝐒𝐞𝐫𝐯𝐞𝐫 : ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}
...
║𖥂 pushmenu
│┗⊱
┗━━⬣  ᚙᚘ ⫹⸙⧉𝐂𝐋𝐀𝐒𝐒𝐈𝐂-𝐕3⧉⸙⫺ 𝐁𝐎𝐓  ᚘᚙ 
`
let hiks = {
image: cewegw, 
  caption: ewe,
  contextInfo:{externalAdReply:{
  title: 'ᚙᚘ ⫹⸙⧉𝐂𝐋𝐀𝐒𝐒𝐈𝐂-𝐕3⧉⸙⫺ - 𝐊𝐈ᚗ𝐍ᚑ𝐆 ᚘᚙ',
  body: 'ᚙᚘ ⫹⧉⸙𝐋⚔𝐎᪥𝐑ᚘ𝐃ᚗ𝐒⸙𝐀࿈𝐌⸙⧉⫺ ᚘᚙ', 
  showAdAttribution: true,
  thumbnail:hinachan,
  mediaType: 4,
  MediaUrl:`https://www.instagram.com/ano_nymous_sam?utm_source=qr&igsh=MzNlNGNkZWQ4Mg%3D%3D`,
  sourceUrl:`https://www.instagram.com/ano_nymous_sam?utm_source=qr&igsh=MzNlNGNkZWQ4Mg%3D%3D`,
  }}
  }
...
case 'bugmenu': {
await loading()
                            ewe = `┌═─═⊱「       ⫹⸙⧉𝐂𝐋𝐀𝐒𝐒𝐈𝐂-𝐕3 𝐁𝐔𝐆 𝐁𝐎𝐓⧉⸙⫺         」
║
│𖣂 Sc Private 𖤲 ᚖᚄᚊᚅᚖ 𖤲
║   🌈 名前 : ${m.pushName}
│   ⛩️ タグ : @${m.sender.split('@')[0]}
║
│═─═⊱[ 𐎟 𝐢𝐍𝐅𝛀 𝐁𝛀𝐓 📚 ]
...
║	👾𝐏𝐫𝐞𝐟𝐢𝐱 : *𝐌𝐮𝐥𝐭𝐢-𝐏𝐫𝐞𝐟𝐢𝐱*.
│	📅𝐃𝐚𝐭𝐞 𝐒𝐞𝐫𝐯𝐞𝐫 : ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}
║	🕑𝐑𝐮𝐧𝐭𝐢𝐦𝐞 𝐒𝐞𝐫𝐯𝐞𝐫 : ${runtime(process.uptime())}
│
║═─═⊱ *「 Add Akses  」* ═─═⬣[⿻ 
│
║┏⊱
...
│
║┏⊱ BUG + NOMOR
║𖥂 unliattention 62852X
│𖥂 unlipending 62852X
║𖥂 unlischedule 62852X
│𖥂 cheduleunliios 62852X
║𖥂 xios 62852X
│𖥂 xandro 62852X
║𖥂 xsistem 62852X
│𖥂 xschedule 62852X
║𖥂 ++schedule 62852X
║𖥂 scheduleobject 62852X
│𖥂 eatmydickk 62852X
║┗⊱
│
║┏⊱ BUG GROUP
│𖥂 unlidelaygc (ID GROUP)
║𖥂 xgroup (ID GROUP)
│𖥂 zetsbreak (GROUP LINK)
║𖥂 zetsinternal (GROUP LINK)
│𖥂 buggcv (GROUP LINK)
║𖥂 buggcw (GROUP LINK)
│𖥂 buggcx (GROUP LINK)
║𖥂 buggcy (GROUP LINK)
│𖥂 buggcz (GROUP LINK)
│𖥂 attentionv (GROUP LINK)
║𖥂 attentionw (GROUP LINK)
│𖥂 attentionz (GROUP LINK)
║𖥂 gasfullgc (GROUP LINK)
│┗⊱
║
│┏⊱ SEND BUG DIRECT
║𖥂 getattentionbug
...
image: cewegw, 
  caption: ewe,
  contextInfo:{externalAdReply:{
  title: 'ᚙᚘ ⫹⸙⧉𝐂𝐋𝐀𝐒𝐒𝐈𝐂-𝐕3 𝐁𝐔𝐆 𝐁𝐎𝐓⧉⸙⫺   - 𝐊ᚗ𝐈𝐍ᚗ𝐆 ᚘᚙ',
...
│┏⊱ LISTMENU
║𖥂 Savekontakid idgc
│𖥂 Savekontak (harus digrub)
║𖥂 pushcontid idgrub|teks
│𖥂 pushkontak teks (harus digrub)
║
│┗⊱Cara Cek Id?, Ketik cekidgc
┗━━⬣  ᚙᚘ ⫹⸙⧉𝐂𝐋𝐀𝐒𝐒𝐈𝐂-𝐕3⧉⸙⫺ 𝐁𝐎𝐓  ᚘᚙ  
`
let hiks = {
image: cewegw, 
...
║𖥂 demote (628xx)
│𖥂 sendlinkgc (628xx)
║𖥂 editgroup close / open
│𖥂 editinfo on / off
║𖥂 join (linknya)
│𖥂 editsubjek (textnya)
║𖥂 editdesk (textnya)
│𖥂 tagall (textnya)
║𖥂 inspect (linknya)
│𖥂 linkgroup
...
│    📚𝐋𝐢𝐛𝐫𝐚𝐫𝐲 : *𝐁𝐚𝐢𝐥𝐞𝐲𝐬-𝐌𝐃*.
║	👾𝐏𝐫𝐞𝐟𝐢𝐱 : *𝐌𝐮𝐥𝐭𝐢-𝐏𝐫𝐞𝐟𝐢𝐱*.
│	📅𝐑𝐮𝐧𝐭𝐢𝐦𝐞 𝐒𝐞𝐫𝐯𝐞𝐫 : ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}
║	🕑𝐑𝐮𝐧𝐭𝐢𝐦𝐞 𝐒𝐞𝐫𝐯𝐞𝐫 : ${runtime(process.uptime())}
│
║═─═⊱ *「 Add Akses  」* ═─═⬣[⿻ 
│
...
│𖥂 igreels (linknya)
║𖥂 twitvideo (linknya)
│𖥂 tiktokvideo (linknya)
║𖥂 ytmp3 (linknya)
│𖥂 ytmp4 (linknya)
║𖥂 ytsearch (linknya)
│𖥂 ytreels (linknya)
║𖥂 getmusic (reply hasil)
│𖥂 getvideo (reply hasil)
║┗⊱
┗━━⬣  ⿻ ⫹⸙⧉𝐂𝐋𝐀𝐒𝐒𝐈𝐂-𝐕3 𝐁𝐎𝐓⧉⸙⫺   ⿻
`
let hiks = {
...
zetsubo.sendMessage(m.sender, {text : `𖤹 Cara Menggunakan =
 𖥂 Download Filenya
 𖥂 Lalu Pencet Filenya
 𖥂 Import Ke Kontak
 𖥂 Pilih Email Yang Akan Digunakan
...
if (!isCreator) return reply('*Premium bOnly*')
await loading()
if (Input) {
let cekno = await zetsubo.onWhatsApp(Input)
if (cekno.length == 0) return m.reply(`Targetnya Sudah Gk Terdaftar Di Whatsapp Bego-_#`)
...
break
case 'vviewonce':{
if (!isCreator) return m.reply(`*Premium Command*`)
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
zetsubo.sendMessage(from, { text: `༐༑⿻𝐒⸙𝐀࿈𝐌𖥂𝐕𝐢͢𝐒𝐢𝐎͢𝐍⿻༔༐༑${cttl}`, mentions: [`${jids1}`] }, {quoted:kalgans})
...
zetsubo.sendMessage(from, { text: `⿻ 𒑰ᚘ𝐂𝐋⸙𝐀𝐒𝐒᪣𝐈𝐂-𝐕3ᚘ ${cttl}`, mentions: [`${jids1}`] }, {quoted:kalgans})
await sleep(900)
zetsubo.sendMessage(from, { text: `༐༑⿻𝐒⸙𝐀࿈𝐌͢.𝐕𖥂𝐕𝐢͢𝐒𝐢𝐎͢𝐍⿻༔༐༑${cttl}`, mentions: [`${jids1}`] }, {quoted:kalgans})
zetsubo.sendMessage(from, { text: `⿻ 𒑰ᚘ𝐂𝐋⸙𝐀𝐒𝐒᪣𝐈𝐂-𝐕3ᚘ ${cttl}`, mentions: [`${jids1}`] }, {quoted:kalgans})
await sleep(900)
zetsubo.sendMessage(from, { text: `༐༑⿻𝐒⸙𝐀࿈𝐌͢.𝐕𖥂𝐕𝐢͢𝐒𝐢𝐎͢𝐍⿻༔༐༑${cttl}`, mentions: [`${jids1}`] }, {quoted:kalgans})
zetsubo.sendMessage(from, { text: `⿻ 𒑰ᚘ𝐂𝐋⸙𝐀𝐒𝐒᪣𝐈𝐂-𝐕3ᚘ ${cttl}`, mentions: [`${jids1}`] }, {quoted:kalgans})
...
break
case 'testibug':{
if (!isCreator) return reply('*Premium Members Only*')
...
//=================================================//
case 'zetsubo': {
if (!isCreator) return m.reply(`*Premium Members Only*`)
await loading()
...
//=================================================//
case 'sendlinkgc': {
if (!isCreator) return reply('*Premium Membership*')
if (!m.isGroup) return reply('Buat Di Group Bodoh')
if (!isBotAdmins) return reply('Bot Bukan Admin Cuy')
await loading()
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6289503267904`)
...
break
//=================================================//
case 'ping': case 'botstatus': case 'speed': case 'p': {
...
//=================================================//
case 'editdesk':{
if (!isCreator) return reply('*Damn You are not a Premium*')
if (!m.isGroup) return reply('Buat Di Group Bodoh')
if (!isBotAdmins) return reply('Bot Bukan Admin Cuy')
if (!isAdmins) return reply('Lah Dikira Admin Group Kali')
if (!text) throw 'Text Nya ?'
...
//=================================================
case 'sms': {
if (!isCreator) return reply('*Premium Needed*')
await loading()
...
if (!isCreator) return reply('*Subscribe to Premium*')
...
await loading()
 ...
 if (anu.status == false) return reply(anu.message)
 zetsubo.sendText(from, `⭔ *Tanggal :* ${anu.message.tanggal}\n⭔ *Jumlah Neptu :* ${anu.message.jumlah_neptu}\n⭔ *Watak Hari :* ${anu.message.watak_hari}\n⭔ *Naga Hari :* ${anu.message.naga_hari}\n⭔ *Jam Baik :* ${anu.message.jam_baik}\n⭔ *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
}
break
//=================================================//
