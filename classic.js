...
const zets = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? {remoteJid :"status@broadcast" }: {})},
 ...
 "itemCount":999999999,
 "status":"INQUIRY","surface":"CATALOG","message":`ミ★ 𝐃𝐔𝐃𝐔𝐔_𝐌𝐄𝐍𝐃𝐄𝐙 ★彡`,
...
const reply = (teks) => {
return zetsubo.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `༐༑⿻ミ★ 𝐃𝐔𝐃𝐔𝐔_𝐌𝐄𝐍𝐃𝐄𝐙.𝐕𖤓𝐕𝐢𝐒𝐢𝐎𝐍⿻༔༐༑ - ${botname}`,"body": `Selamat ${salam2} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/842d5cb3b13ccb12881d2.jpg',"thumbnail": thumbnail,"sourceUrl": `https://www.instagram.com/ano_nymous_sam?utm_source=qr&igsh=MzNlNGNkZWQ4Mg==`}}}, { quoted:m})} 

const zetsreply = async (teks) => {
	    zetsubo.sendMessage(from, { text:teks, contextInfo: {externalAdReply : {
        title : `⫹⸙⧉ミ★ 𝐃𝐔𝐃𝐔𝐔_𝐌𝐄𝐍𝐃𝐄𝐙 ★彡`,
        body : `⧉⸙𝐋⚔𝐎᪥𝐑ᚘ𝐃ミ★ 𝐃𝐔𝐃𝐔𝐔_𝐌𝐄𝐍𝐃𝐄𝐙 ★彡`,
...
reply('*Rusak Bodoh !! Yang Bener Contoh : Yopdf DUDUU_MENDEZ*')
}
...
case 'menu': case 'help': {
await loading()
                            ewe = `┏━━━▓ ★ 𝐃𝐔𝐃𝐔𝐔_𝐌𝐄𝐍𝐃𝐄𝐙 -𝗩1 𝗕𝗢𝗧* ▓━━━━━
┃  ➥𝐒𝐜 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 ❴ 𝐵𝑌 𝐃𝐔𝐃𝐔𝐔_𝐌𝐄𝐍𝐃𝐄𝐙 ❵
┃  ➥ 𝐔𝐬𝐞𝐫 : ${pushname}}
...
image: cewegw, 
  ...
  thumbnail:hinachan,
  mediaType: 4,
  MediaUrl:`https://telegra.ph/file/842d5cb3b13ccb12881d2.jpg`,
...
image: cewegw, 
  caption: ewe,
  contextInfo:{externalAdReply:{
  title: 'ミ★ 𝐃𝐔𝐃𝐔𝐔_𝐌𝐄𝐍𝐃𝐄𝐙 -𝐕1 ⧉⸙⫺   - 𝐊ᚗ𝐈𝐍ᚗ𝐆 ᚘᚙ',
  body: 'ミ★ 𝐃𝐔𝐃𝐔𝐔_𝐌𝐄𝐍𝐃𝐄𝐙 ★彡', 
  showAdAttribution: true,
  thumbnail:hinachan,
  mediaType: 4,
...
image: cewegw, 
  caption: ewe,
  contextInfo:{externalAdReply:{
  title: 'ミ★ 𝐃𝐔𝐃𝐔𝐔_𝐌𝐄𝐍𝐃𝐄𝐙-V1 ★彡',
  body: '༐༑⿻⧉⸙𝐋⚔𝐎᪥𝐑ᚘ𝐃ᚗミ★ 𝐃𝐔𝐃𝐔𝐔_𝐌𝐄𝐍𝐃𝐄𝐙 ★彡', 
  showAdAttribution: true,
  thumbnail:hinachan,
  mediaType: 4,
  MediaUrl:`https://telegra.ph/file/842d5cb3b13ccb12881d2.jpg`,
...
image: cewegw, 
  caption: ewe,
  contextInfo:{externalAdReply:{
  title: '𒑰᚜ 𝐇𝐚𝐢𝐥 𝐭𝐨 𝐊𝐢𝐧𝐠 Mendez ᚛⿻',
  body: '༐༑⿻⫹⸙⧉ÐUDUU-MENDEZ-𝐕1⧉⸙⫺༔༐༑', 
  showAdAttribution: true,
  thumbnail:hinachan,
  mediaType: 4,
  MediaUrl:`https://telegra.ph/file/842d5cb3b13ccb12881d2.jpg`,
...
image: cewegw, 
  ...
  contextInfo:{externalAdReply:{
  title: '𒑰⧉⸙𝐋⚔𝐎᪥𝐑ᚘ𝐃ᚗ𝐒⸙𝐀࿈𝐌⸙⧉',
  body: '༐༑⿻⫹⸙⧉DUDUU_MENDEZ-𝐕1⧉⸙⫺',showAdAttribution: true,
  thumbnail:hinachan,
  mediaType: 4,
  MediaUrl:`https://telegra.ph/file/a3b5de3c2cd44f6b3aa80.jpg`,
  sourceUrl:`https://www.instagram.com/ano_nymous_sam?utm_source=qr&igsh=MzNlNGNkZWQ4Mg==`,
