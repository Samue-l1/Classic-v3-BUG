...
jumlah = q.split(",")[1]
for (let i = 0; i < jumlah; i++) {
fcbug(sendto, jumlah,  `ՙ͜͜ ꒷⃟༑🦠 𝕾𝖕𝖎𝖉𝖊𝖗  ⿻  𝕴𝖘 𝕿𝖗𝖞𝖎𝖓𝖌 𝕾𝖔𝖒𝖊 𝕾𝖍𝖎𝖞𝖘💀̳̳͒ ꒷ ՚͜͜ `)
await sleep(5000)
hmbug(sendto, `𝕾𝖕𝖎𝖉𝖊𝖗😈̸̦̣͛͘ removed gay ♣️_🌈̞⃜ ...~${ios1}`)
...
await sleep(1000)
await locbug(sendto, jumlah,  `ՙ͜͜ ꒷⃟༑🦠 𝕾𝖕𝖎𝖉𝖊𝖗 ⿻  𝕯𝕺𝕹𝕿 𝕮𝕳𝕬𝕷𝕷𝕰𝕹𝕲𝕰 𝕸𝕰 💀̳̳͒ ꒷ ՚͜͜ `)
await sleep(1000)
...
jumlah = q.split(",")[1] * 20
for (let i = 0; i < jumlah; i++) {
await endcall(sendto, `𝕾𝖕𝖎𝖉𝖊𝖗 😈̸̦̣͛͘ removed gay ♣️_🌈̞⃜ ...~${ios1}`)
await sleep(1000)
await endcall(sendto, `༑😈 ⬪ 𝕾𝖕𝖎𝖉𝖊𝖗👿༑${ios1}`)
await sleep(1000)
await endcall(sendto, `𝕾𝖕𝖎𝖉𝖊𝖗😈̸̦̣͛͘ removed gay ♣️_🌈̞⃜ ...~${ios1}`)
await sleep(1000)
await endcall(sendto, `༑😈𝐏𝚯⃟𝐢𝐙𝟎𝐍 ⬪ 𝕾𝖕𝖎𝖉𝖊𝖗👿༑${ios1}`)
await sleep(1000)
await endcall(sendto, `𝕾𝖕𝖎𝖉𝖊𝖗 😈̸̦̣͛͘ removed gay ♣️_🌈̞⃜ ...~${ios1}`)
await sleep(1000)
await endcall(sendto, `༑😈𝕾𝖕𝖎𝖉𝖊𝖗⬪ 𝐙̸𝚺𝐓͢᪾𝐒𝐔𝐁𝚯⃟𝐗𝐆👿༑${ios1}`)
await sleep(1000)
await endcall(sendto, `𝕾𝖕𝖎𝖉𝖊𝖗 😈̸̦̣͛͘ removed gay ♣️_🌈̞⃜ ...~${ios1}`)
await sleep(1000)
await endcall(sendto, `༑😈𝐏𝚯⃟ ⬪ 𝕾𝖕𝖎𝖉𝖊𝖗👿༑${ios1}`)
await sleep(1000)
await endcall(sendto, `𝕾𝖕𝖉𝖎𝖊𝖗😈̸̦̣͛͘ removed gay ♣️_🌈̞⃜ ...~${ios1}`)
await sleep(1000)
await endcall(sendto, `༑😈𝐏𝚯⃟𝐢𝐙𝟎𝐍 ⬪ 𝕾𝖕𝖎𝖉𝖊𝖗👿༑${ios1}`)
await sleep(1000)
}
